...
router.get('/users/dashboard-stats/admin', UserController.getDashboardStatsAdmin);
...
router.get('/pawn-transactions/search/advanced', PawnTransactionController.searchAdvanced);
