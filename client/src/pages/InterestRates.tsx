        ...
        <CardContent className="p-0">
          <Table>
            ...
            <TableBody>
              ...
              {rates.length === 0 && (
                <TableRow><TableCell colSpan={4} className="text-center text-muted-foreground py-8">No interest rates found</TableCell></TableRow>
              )}
            </TableBody>
          </Table>
        </CardContent>
      ...
      <Dialog open={showDialog} onOpenChange={setShowDialog}>
        <DialogContent>
          ...
          <form onSubmit={handleAdd} className="space-y-4">
            <div><Label>Rate Name</Label><Input value={name} onChange={(e) => setName(e.target.value)} required placeholder="e.g. Standard Rate" /></div>
