...
// Brand palette, matching styles/settings/_index.scss ($primary etc.) — the
// upstream component reads these from CRA-style process.env.REACT_APP_*_COLOR
// vars, which don't exist under Vite, so the hex values are inlined instead.
const BRAND_COLORS = {
	primary: '#3c83f6',
	secondary: '#303d4f',
	success: '#46bcaa',
			...
			<ReactApexChart
				options={{
					...
					plotOptions: {
						candlestick: {
							colors: {
								upward: BRAND_COLORS.success,
								downward: BRAND_COLORS.danger,
							},
						},
						boxPlot: {
							colors: {
								upper: BRAND_COLORS.success,
								lower: BRAND_COLORS.danger,
							},
						},
					},
					...options,
