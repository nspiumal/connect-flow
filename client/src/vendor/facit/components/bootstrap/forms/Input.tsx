...
export interface IInputProps extends HTMLAttributes<HTMLInputElement> {
	// react-input-mask is not vendored (no masked input exists in this app) —
	// only the `component='NumberFormat'` / `format` path is supported.
...
Input.propTypes = {
	component: PropTypes.oneOf(['NumberFormat']),
