...
router.post('/users/verify-manager-pin', UserController.verifyManagerPin);
...
router.get('/branches/active', BranchController.getActive);
router.get('/branches/paginated', BranchController.getPaginated);
...
router.get('/interest-rates/active', InterestRateController.getActive);
...
router.post('/interest-rates/:id', InterestRateController.update);
router.patch('/interest-rates/:id/toggle-active', InterestRateController.toggleActive);
router.delete('/interest-rates/:id', InterestRateController.delete);

// ── Item Types ────────────────────────────────────────────────────────────────
router.get('/item-types', ItemTypeController.getAll);
router.get('/item-types/active', ItemTypeController.getActive);
...
router.post('/item-types/:id', ItemTypeController.update);
router.patch('/item-types/:id/toggle-active', ItemTypeController.toggleActive);
...
router.get('/pawn-transactions/search/advanced', PawnTransactionController.search);
...
router.get('/pawn-transactions/status/:status', PawnTransactionController.getByStatus);
router.get('/pawn-transactions/branch/:branchId/paginated', PawnTransactionController.getByBranchPaginated);
...
router.get('/pawn-transactions/:id/history', PawnTransactionController.getEditHistory);
router.get('/pawn-transactions/:id/profit', PawnTransactionController.getProfit);
...
router.patch('/pawn-transactions/:id/block-reason', PawnTransactionController.updateBlockReason);
router.patch('/pawn-transactions/:id/details', PawnTransactionController.updateDetails);
router.post('/pawn-transactions/:id/profit', PawnTransactionController.setProfit);
...
router.get('/pawn-redemptions/transaction/:transactionId', PawnRedemptionController.getByTransaction);
...
router.post('/blacklist/:id', BlacklistController.update);
...
router.post('/images/upload-multiple', ...ImageUploadController.uploadMultiple);
router.get('/images/serve/:filename', imageLimiter, ImageServeController.serveImage);
router.delete('/images/delete', ImageUploadController.deleteImage);
...
router.get('/profits/paginated', ProfitedTransactionController.getPaginated);
...
// ── Profited Transactions (alias for /profits) ────────────────────────────────
router.get('/profited-transactions/paginated', ProfitedTransactionController.getPaginated);
router.get('/profited-transactions/search', ProfitedTransactionController.search);
router.get('/profited-transactions', ProfitedTransactionController.getAll);
